...
export function DropDownItem({ children, className, onClick, title, }) {
    ...
    return (<button className={className} onClick={onClick} ref={ref} title={title}>
        {children}
      </button>);
}
...
export default function DropDown({ buttonLabel, buttonAriaLabel, buttonClassName, buttonIconClassName, children, stopCloseOnClickSelf, }) {
    ...
    return (<>
        <button aria-label={buttonAriaLabel || buttonLabel} className={buttonClassName} onClick={() => setShowDropDown(!showDropDown)} ref={buttonRef}>
